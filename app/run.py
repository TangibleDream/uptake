...
def calculate_feet(formatted_data):
    ...
    """
    """return int(formatted_data['length']) * int(formatted_data['width']) * int(formatted_data['height'])  This calculation is clearly incorrect, replaced"""
...
def calculate_gallons_required(formatted_data):
    ...
    """
    """return math.floor(formatted_data['ft'] / 350) flipped logic, rounds down instead of up, 350 instead of 400 looks weird too"""
